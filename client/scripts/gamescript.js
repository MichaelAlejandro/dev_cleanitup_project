const gameContainer = document.getElementById('gameContainer');
        ...
        if (newBackgroundIndex !== currentBackgroundIndex) {
            ...
            document.body.style.backgroundImage = backgrounds[currentBackgroundIndex+1];
            document.body.style.backgroundSize = 'cover';
            document.body.style.backgroundPosition = 'center';
        }
        }
        ...
        function initGame() {
            ...
            player.innerHTML = '<img src="../static/imagenes/player.png" alt="Jugador" style="width: 100%; height: 100%;">';
